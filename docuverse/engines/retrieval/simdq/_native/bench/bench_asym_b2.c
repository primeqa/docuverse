// bench_asym_b2.c — asymmetric b=2 (float query x 2-bit DB) top-K scan
// throughput.
//
// CLI: bench_asym_b2 [n] [reps] [K]
...
int main(int argc, char **argv) {
    ...
    // warmup
    scan_asym_b2_topk_parallel(codes, n, /*d=*/768, q, K, out_s, out_i);
    ...
    printf("kernel=%s threads=%d n=%zu K=%d reps=%d  best=%.3fms  cmp/s=%.2fM  GB/s=%.1f  top1=%lld score=%f\n",
           ASYM_B2_KERNEL_NAME, omp_get_max_threads(), n, K, reps, tmin * 1e3,
